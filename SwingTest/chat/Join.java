	...
	public Join() {
		...
		registerBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (id.getText() != null && pw.getText() != null && checkPw.getText() != null
						&& name.getText() != null) {
					if (pw.getText().equals(checkPw.getText())) {
						JoinInsert test = new JoinInsert(id.getText(), id.getText(), name.getText(), email.getText(),
								phone.getText());
					} else {
						int t = JOptionPane.showConfirmDialog(null, "비밀번호가 다릅니다.", "", JOptionPane.WARNING_MESSAGE,
								JOptionPane.DEFAULT_OPTION);

					}
				} else {
					int t = JOptionPane.showConfirmDialog(null, "정보를 다 입력하지 않았습니다.", "", JOptionPane.WARNING_MESSAGE,
							JOptionPane.DEFAULT_OPTION);
				}
			}
		});
